            ...
            if (task.isSuccessful()) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    if (iterationCounter == 0) {
                        numText.setText(String.valueOf(violationTable.getChildCount() ));  // First iteration: -1
                    } else {
                        numText.setText(String.valueOf(violationTable.getChildCount() - 2));  // Subsequent iterations: -2
                        iterationCounter++;
                    }
                    ...
                    TextView numText1 = new TextView(getContext());
                    numText1.setText(" ");
                    numText1.setPadding(16, 16, 16, 16);
                    detailsRow.addView(numText1);
                    ...
                    // Create buttons for "Settled", "Edit", "Refer to Guidance"
                    TextView numText2 = new TextView(getContext());
                    numText2.setText(" ");
                    numText2.setPadding(16, 16, 16, 16);
                    buttonRow.addView(numText2);
                    ...
                    settledButton.setOnClickListener(v -> {
                        ...
                        showSanctionInputDialog(violationReference);

                        // Update the violation status to "Settled"
                        updateViolationStatus(violationReference, "Settled");
                    });
                    ...
                    // Add the details and button rows to the table
                    violationTable.addView(detailsRow);
                    violationTable.addView(buttonRow);

                    // Set an OnClickListener on the main row to toggle details and button visibility
