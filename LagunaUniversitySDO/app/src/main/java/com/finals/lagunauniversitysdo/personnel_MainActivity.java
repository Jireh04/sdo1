...
public class personnel_MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            navigationView.setCheckedItem(R.id.refferalForm); // Make sure this is still the correct ID for your menu
            toolbarTitle.setText("Personnel Referral Form"); // Update title as needed
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.refferalForm) {
            selectedFragment = new personnel_refferal_form(); // Change to personnel_refferal_form
