...
public class dashboard_prefect extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        boxSection = rootView.findViewById(R.id.box_section);            // Box section
    ...
    private void searchStudents() {
        ...
        // Hide the referral buttons and box section when search is clicked
        //referralSection.setVisibility(View.GONE);
        boxSection.setVisibility(View.GONE);
    ...
    public void showAddViolatorDialog(String studId, String name) {
        ...
        View dialogView = inflater.inflate(R.layout.dialog_add_violator, null);
    ...
    private void openReferralDashboard() {
        Intent intent = new Intent(getActivity(), PrefectReferralDashboardActivity.class);
        startActivity(intent);
    }
}
